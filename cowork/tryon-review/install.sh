...
# Use the platform-injected mirror when present, otherwise the corporate mirror.
# Both the template verifier and the deployed Pod require an internal package source.
export PIP_INDEX_URL="${PIP_INDEX_URL:-http://pypi.devops.xiaohongshu.com/simple/}"
export PIP_TRUSTED_HOST="${PIP_TRUSTED_HOST:-pypi.devops.xiaohongshu.com}"

...
Downloaded as SVG path data from Alibaba Iconfont on 2026-08-21 and normalized to `currentColor` for the selfit share sheet.

| Asset | Iconfont name | Icon ID | Search |
| --- | --- | ---: | --- |
| `icon-save.svg` | 下载 | 4880421 | https://www.iconfont.cn/search/index?q=下载&searchType=icon |

...
- The mirror's compact recommendation header shows “今日推荐” on the left and a 44px-tall “试穿记录” text action on the right. Move history out of the upper-right mirror area; keep the device-link action there. Reclaim space from below the cards, pagination and navigation instead of changing photo-fit rules. Keep cards clear of the fixed navigation and retain safe-area/short-screen scrolling (user correction, 2026-09-14).
...
- The mirror's link icon opens the device-code dialog: title “绑定你的智能穿衣镜”, description “每日记录身材和穿搭”, and a single four-digit numeric input with placeholder “请输入设备码”. Preserve leading zeros and reject other characters. The “试穿记录” action below the mirror remains available after try-on.
